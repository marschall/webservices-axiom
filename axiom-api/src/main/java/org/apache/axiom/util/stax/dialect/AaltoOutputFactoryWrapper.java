...
class AaltoOutputFactoryWrapper extends NormalizingXMLOutputFactoryWrapper {
    AaltoOutputFactoryWrapper(XMLOutputFactory parent, AbstractStAXDialect dialect) {
