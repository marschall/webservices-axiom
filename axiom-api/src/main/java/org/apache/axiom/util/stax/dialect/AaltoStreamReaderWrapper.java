...
class AaltoStreamReaderWrapper extends StAX2StreamReaderWrapper implements DelegatingXMLStreamReader, CharacterDataReader {
    AaltoStreamReaderWrapper(XMLStreamReader reader) {
        super(reader);
    }
